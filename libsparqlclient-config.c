...
static const char *short_program_name = "libsparqlclient-config";
...
usage(void)
{
	fprintf(stderr, "Print the libsparqlclient build configuration\n");
	fprintf(stderr, "Usage: %s OPTIONS\n\n", short_program_name);
	fprintf(stderr, "OPTIONS is one or more of:\n"
			"  -h, --help          Display this usage message and exit\n"
			"  -v, --version       Print the libsparqlclient version\n"
